...
class Agent:
    def __init__(self, input_dims, alpha, beta,gamma,Start_Noise,Noise_Decay,
        ...
        self.actor = ActorNetwork(n_actions=n_actions, name='actor_SMax')
        self.critic = CriticNetwork(name='critic_SMax')
        self.target_actor = ActorNetwork(n_actions=n_actions,
                                         name='target_actor_SMax')
        self.target_critic = CriticNetwork(name='target_critic_SMax')
